/* 
SCRIPT BASE: ADRIAN
SCRIPT RECODE: QYUNEE
SCRIPT REMAKE: KASTARA
AUTHOR: KASTARA
         DONASI
DANA: 085742344873
*/
...
let user = global.db.data.users[m.sender]
newReply(`
🌤️ Kamu kembali dari AFK${user.afkReason ? ' Setelah: ' + user.afkReason : ''}
...
newReply(`*MOTANA TIDAK MENYEDIAKAN SCRIPT SAAT INI* `)
        break
...
break
            ...
            case 'attp':
                try {
                if (args.length == 0) return newReply(`Example: ${prefix + command} Motana`)
    ...
    // Text Prome
        ...
        break
            ...
            if (!text) return newReply(`Example: ${prefix + command} Motana`)
			...
			case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) return newReply(`Contoh : ${prefix + command} 6281234567890`)
